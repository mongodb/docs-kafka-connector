...
.. tabs::
   ...
   .. tab::
      ...
      :github:`the {+connector-short+} source code </mongodb/mongo-kafka/tree/{+connector_version_github_tag+}/src/main/java/com/mongodb/kafka/connect/sink/cdc/debezium>`.
   ...
   .. tab::
      ...
      To view the source code for the Debezium CDC handler, see
      :github:`the {+connector-short+} source code <mongodb/mongo-kafka/blob/{+connector_version_github_tag+}/src/main/java/com/mongodb/kafka/connect/sink/cdc/debezium/rdbms/postgres/PostgresHandler.java>`.
   ...
   .. tab::
      ...
      To view the source code for the Debezium CDC handler, see
      :github:`the {+connector-short+} source code <mongodb/mongo-kafka/blob/{+connector_version_github_tag+}/src/main/java/com/mongodb/kafka/connect/sink/cdc/debezium/rdbms/mysql/MysqlHandler.java>`.
